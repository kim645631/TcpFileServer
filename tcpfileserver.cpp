    ...
    : QDialog(parent)
{
    ...
    connect(&tcpServer,SIGNAL(newConnection()),this,SLOT(acceptConnectiom()));
...
void TcpFileServer::acceptConnectiom(){
...
void TcpFileServer::displayError(QAbstractSocket::SocketError socketError){
    if(socketError == QTcpSocket::RemoteHostClosedError)
        return;
    QMessageBox::information(this,tr("網路錯誤"),
                             tr("產生如下錯誤: %1.")
